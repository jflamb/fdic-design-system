...
const icons: Record<string, string> = {
  ...
  "check-square":
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor"><path d="M208,32H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32ZM98.34,161.66a8,8,0,0,1-11.31,0l-31-31a8,8,0,0,1,11.31-11.32l25.35,25.35,67.32-67.31a8,8,0,0,1,11.31,11.31Z"/></svg>',
