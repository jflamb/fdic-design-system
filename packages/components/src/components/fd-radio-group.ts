...
export class FdRadioGroup extends LitElement {
  ...
  static styles = [forcedColorsFieldGroup, css`
    ...
    [part="legend"] {
      padding: 0;
      margin: 0 0 var(--fd-radio-group-legend-gap, var(--ds-spacing-xs, 8px)) 0;
      float: none;
      width: 100%;
    ...
    [part="description"] {
      ...
      margin: 0 0 var(--fd-radio-group-description-gap, var(--ds-spacing-sm, 12px)) 0;
    }
    ...
    [part="items"] {
      display: grid;
      gap: var(--fd-radio-group-gap, var(--ds-spacing-sm, 12px));
    }
