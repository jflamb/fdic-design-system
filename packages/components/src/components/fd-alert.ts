...
import {
  REGULAR_CHECK_ICON_SVG,
  REGULAR_INFO_ICON_SVG,
  REGULAR_WARNING_CIRCLE_ICON_SVG,
  REGULAR_WARNING_ICON_SVG,
  REGULAR_WARNING_OCTAGON_ICON_SVG,
  REGULAR_X_ICON_SVG,
...
function decorateFallbackIcon(svg: string): string {
  return svg.replace("<svg ", '<svg aria-hidden="true" ');
}

const FALLBACK_ICON_SVG: Record<AlertType, string> = {
  info: decorateFallbackIcon(REGULAR_INFO_ICON_SVG),
  success: decorateFallbackIcon(REGULAR_CHECK_ICON_SVG),
  warning: decorateFallbackIcon(REGULAR_WARNING_ICON_SVG),
  error: decorateFallbackIcon(REGULAR_WARNING_CIRCLE_ICON_SVG),
  emergency: decorateFallbackIcon(REGULAR_WARNING_OCTAGON_ICON_SVG),
};
