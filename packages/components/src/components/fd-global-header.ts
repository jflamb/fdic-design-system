 28.6035C44.1727 30.1525 42.4152 31.389 40.3896 32.3125C38.3937 33.236 36.2337 33.6982 33.9102 33.6982H20.9502V0.00195312H33.9102ZM61.2637 33.6982H52.5059V0.00195312H61.2637V33.6982ZM101.784 13.3408C103.98 13.3409 105.689 13.9521 106.911 15.1738C108.133 16.3957 108.744 18.0975 108.744 20.2793V33.415H106.017V21.4795C106.017 19.545 105.609 18.1116 104.795 17.1807C103.995 16.2354 102.751 15.7627 101.063 15.7627C99.0127 15.7628 97.4999 16.374 96.5254 17.5957C95.5654 18.803 95.085 20.7089 95.085 23.3125V33.415H92.4014V14.0605H94.9541V17.0498C95.7396 15.8134 96.7004 14.8892 97.835 14.2783C98.984 13.6531 100.301 13.3408 101.784 13.3408ZM135.763 14.0605H139.646V16.3516H135.763V33.415H133.122V16.3516H129.565V14.0605H133.122V6.11816H135.763V14.0605ZM29.709 26.2793H31.7197C33.2389 26.2793 34.5946 26.041 35.7861 25.5645C36.9778 25.0878 37.9759 24.4319 38.7803 23.5977C39.6144 22.7635 40.2401 21.7806 40.6572 20.6484C41.1041 19.4865 41.3281 18.2201 41.3281 16.8496C41.3281 15.5091 41.1041 14.2575 40.6572 13.0957C40.2104 11.934 39.5704 10.9357 38.7363 10.1016C37.932 9.26743 36.9337 8.61242 35.7422 8.13574C34.5505 7.65906 33.2093 7.4209 31.7197 7.4209H29.709V26.2793ZM120.442 15.9375C118.813 15.9375 117.445 16.4467 116.34 17.4648C115.249 18.483 114.617 19.8364 114.442 21.5234H126.465C126.334 19.749 125.744 18.374 124.697 17.3994C123.65 16.4249 122.231 15.9375 120.442 15.9375Z" fill="currentColor"/>
</g>
<defs>
<clipPath id="fd-global-header-wordmark-clip">
<rect width="139.646" height="34.2656" fill="currentColor"/>
</clipPath>
</defs>
</svg>`;
...
export class FdGlobalHeader extends LitElement {
  ...
  static styles = css`
    ...
    *::after {
    ...
    .fdic-brand-wordmark {
      ...
      align-items: center;
      align-self: center;
      block-size: var(--fd-global-header-wordmark-height, 35px);
      color: var(--fd-global-header-wordmark-color, currentColor);
      overflow: visible;
      border-radius: 0;
      text-decoration: none;
      line-height: 0;
    ...
    .fdic-brand-wordmark svg {
      display: block;
      inline-size: var(--fd-global-header-wordmark-width, 8.75rem);
      block-size: auto;
      overflow: visible;
    }
  ...
  private _renderDefaultBrand() {
    return html`
      <a
        class="fdic-brand-wordmark"
        href="/"
        aria-label="FDICnet home"
      >
        ${unsafeSVG(FDICNET_WORDMARK_SVG)}
      </a>
    `;
  }
        ...
        <div class="masthead" part="masthead">
          <div class="shell masthead-row">
            <div class="brand-row">
              ...
              <slot name="brand">${this._renderDefaultBrand()}</slot>
            </div>
            <div class="controls">
