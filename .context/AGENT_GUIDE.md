...
- When package-surface or workflow-boundary questions come up, check the durable repo records first: [Package Strategy](/Users/jlamb/Projects/fdic-design-system/docs/architecture/package-strategy.md) defines public vs internal imports, and [ADR-005](/Users/jlamb/Projects/fdic-design-system/docs/adr/ADR-005-supported-v1-form-contract.md) defines the supported v1 form contract.
