...
| `--fd-checkbox-border-color` | `var(--ds-color-text-primary, #212123)` | Resting control color |
| `--fd-checkbox-radius` | `var(--fdic-corner-radius-sm, 3px)` | Checkbox corner radius |
| `--fd-checkbox-focus-color` | `var(--ds-color-border-input-focus, #38b6ff)` | Focus ring color |
