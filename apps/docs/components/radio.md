...
| `--fd-radio-icon-color` | `var(--fdic-color-text-primary, #212123)` | Resting control color |
| `--fd-radio-focus-color` | `var(--fdic-color-border-input-focus, #38b6ff)` | Focus ring color |
...
| `--fd-radio-icon-disabled` | `var(--fdic-color-text-disabled, #9e9ea0)` | Control color while disabled |
