...
| `--fd-slider-track-background` | `var(--ds-color-border-input-interactive, #e0e0e2)` | Unfilled rail color. |
| `--fd-slider-track-fill` | `var(--ds-color-primary-500, #0d6191)` | Filled rail color up to the committed value. |
| `--fd-slider-thumb-size` | `20px` | Thumb diameter. |
| `--fd-slider-thumb-border` | `var(--ds-color-icon-active, #1278b0)` | Thumb border color. |
| `--fd-slider-thumb-background` | `var(--ds-color-bg-base, #ffffff)` | Thumb background color at rest. |
| `--fd-slider-thumb-hover-background` | `var(--ds-color-bg-container, #f5f5f7)` | Thumb background while hovered. |
| `--fd-slider-thumb-pressed-background` | `var(--ds-color-bg-selected, #b4e4f8)` | Thumb background while dragged or pressed. |
...
| `--fd-slider-input-border-color` | `var(--ds-color-border-input, #bdbdbf)` | Inline helper input border color. |
| `--fd-slider-input-radius` | `var(--fdic-corner-radius-sm, 3px)` | Inline helper input corner radius. |
| `--fd-slider-input-background` | `var(--ds-color-bg-base, #ffffff)` | Inline helper input background color. |
